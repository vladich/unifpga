// =============================================================================
// 3_1_note_recognizer — auto-adapted by tools/adapt_designs.py from
//   basics-graphics-music/labs/3_music/3_1_note_recognizer/lab_top.sv
// =============================================================================
//
// requires:
//   seven_segment >= 1
...
(
    ...
    // seven_segment_display # (w_digit)
    // i_7segment (.number ((distance [19:4])), .*);
