...
module uart_tx (
    ...
    always_comb begin
        case(baudrate_i)
            17'd9600  : cfg_div_i = 16'd1041;
            17'd19200 : cfg_div_i = 16'd520;
            17'd38400 : cfg_div_i = 16'd259;
            17'd57600 : cfg_div_i = 16'd173;
            17'd115200: cfg_div_i = 16'd86;
            default   : cfg_div_i = 16'd1041;
        endcase
    end
    enum logic [2:0] {IDLE=3'b000,START_BIT=3'b001,DATA=3'b010,PARITY=3'b011,STOP_BIT_FIRST=3'b100,STOP_BIT_LAST=3'b101} CS,NS;
