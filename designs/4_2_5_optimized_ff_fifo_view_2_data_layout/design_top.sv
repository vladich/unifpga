// =============================================================================
// 4_2_5_optimized_ff_fifo_view_2_data_layout — auto-adapted by tools/adapt_designs.py from
//   basics-graphics-music/labs/4_microarchitecture/4_2_5_optimized_ff_fifo_view_2_data_layout/lab_top.sv
// =============================================================================
//
// requires:
//   buttons >= 2
...
(
    ...
    wire [w_digit - 1:0] dots_from_ptrs
        =   ((1) << (fifo_depth - 1 - wr_ptr))
          | ((1) << (fifo_depth - 1 - rd_ptr));
