// =============================================================================
// 5_4_yrv — auto-adapted by tools/adapt_designs.py from
//   basics-graphics-music/labs/5_cpu/5_4_yrv/lab_top.sv
// =============================================================================
//
// requires:
//   seven_segment >= 1
...
(
    ...
    always_comb
        if (slow_addr_data_sel)
            display_number = (mem_addr);
        else
            display_number = (mem_rdata);
