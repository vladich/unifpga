...
(
    ...
    begin
        ...
        begin
            ...
            p1_offset <= get_player_offset(btn[w_btn - 2], btn[w_btn - 1], p1_offset);
            p2_offset <= get_player_offset(btn[0], btn[1], p2_offset);
            end
            else if (w_btn == 1)
            begin : gen_one_key
            p1_offset <= get_player_offset(~btn[0], btn[0], p1_offset);
            p2_offset <= get_player_offset(~btn[0], btn[0], p2_offset);
            end
