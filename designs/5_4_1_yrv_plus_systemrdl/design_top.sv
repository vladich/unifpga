// =============================================================================
// 5_4_1_yrv_plus_systemrdl — auto-adapted by tools/adapt_designs.py from
//   basics-graphics-music/labs/5_cpu/5_4_1_yrv_plus_systemrdl/lab_top.sv
// =============================================================================
//
...
(
    ...
    //------------------------------------------------------------------------
    // Board-specific btn and switch assignments
    ...
    generate
        ...
        begin : keys_at_least_7
            ...
            assign slow_clk_mode          = btn [w_btn - 1];
            assign slow_addr_data_sel     = btn [w_btn - 2];
            assign external_interrupt_raw = btn [w_btn - 3];
            assign local_interrupt_0_raw  = btn [w_btn - 4];
            assign local_interrupt_1_raw  = btn [w_btn - 5];
        ...
        begin : keys_at_least_4
            ...
            assign external_interrupt_raw = btn [w_btn - 2];
    ...
    import yrv_mcu_passthrough_pkg::*;
    yrv_mcu_passthrough__out_t hwif_out;
    ...
    assign led = (hwif_out.YRV_MCU_LED_CTRL.CTRL.value);
