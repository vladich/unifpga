...
(                debug_mode, wfi_state, 
  ...
  output        yrv_mcu_passthrough__out_t hwif_out;
...
`endif
  ...
  wire        cpuif_rd_ack, cpuif_wr_ack;
  wire [31:0] cpuif_rd_data;
  wire [31:0] cpuif_wr_biten ={{8{mem_ble_reg[3]}}, {8{mem_ble_reg[2]}}, {8{mem_ble_reg[1]}}, {8{mem_ble_reg[0]}}};

  yrv_mcu_passthrough i_yrv_mcu_passthrough  
  (      
    .clk(clk), .rst(~resetb),      
    .s_cpuif_req(io_wr_reg | io_rd_reg),      
    .s_cpuif_req_is_wr(io_wr_reg ),      
    .s_cpuif_addr(mem_addr_reg[2:0]),      
    .s_cpuif_wr_data(mem_wdata),      
  ...
  assign mcu_rdata = mem_rd_reg ? mem_rdata : cpuif_rd_data;
