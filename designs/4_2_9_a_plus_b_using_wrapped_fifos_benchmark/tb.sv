// =============================================================================
// 4_2_9_a_plus_b_using_wrapped_fifos_benchmark testbench — auto-adapted by tools/adapt_designs.py --testbenches from
//   basics-graphics-music/labs/4_microarchitecture/4_2_9_a_plus_b_using_wrapped_fifos_benchmark/tb.sv
...
# (
    ...
    `ifdef BENCHMARK
        localparam timeout = 1_000_000_000;
    `else
    ...
    `ifdef BENCHMARK
        localparam max_transfers = 10_000_000;
    `else
