// Simulation models for the graphics testbenches: tb_lcd_480_272 scans a
// 480x272 LCD (every 9th line, to keep waveforms short) and gives x / y;
// tb_lcd_display keeps 30 lines of one pixel bit so the picture shows as
// signal lines in a waveform viewer.
